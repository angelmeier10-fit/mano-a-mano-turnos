...
const styles = {
  ...
  giftCardVisualService: {
    fontFamily: "Georgia, 'Times New Roman', serif", fontWeight: 400, fontSize: 26,
    fontStyle: "italic", color: "#D4AF37", marginBottom: 8,
    textShadow: "0 1px 8px rgba(212,175,55,0.3)",
  },
  giftCardVisualTo: {
    fontSize: 12.5, color: "rgba(239,233,223,0.7)", marginBottom: 4,
    letterSpacing: "0.03em",
  },
  giftCardVisualMessage: {
    fontSize: 13, color: "rgba(239,233,223,0.8)", fontStyle: "italic",
